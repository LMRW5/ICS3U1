 ...
 * This class contains the basic information about chips, such as calories,
 * sugar, name, and sodium.
 * 
 * @author Ryan
 * @version 1.0
 */
public class Chips extends Snacks {
    ...
    /**
     * Amount of Sodium inside the chip
     */
     ...
     * 
     * @param calories calories in chip
     * @param sugar    sugar in chip
     * @param name     name of the chip
     * @param sodium   amount of sodium in the chips
     */
     ...
     * 
     * @param chip takes in chip object
